...
// Source: ./internal/domain/segment/service/service.go
...
import (
	...
	model "github.com/VrMolodyakov/segment-api/internal/domain/segment/model"
...
func (m *MockSegmentRepository) Get(ctx context.Context, name string) (model.SegmentInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, name)
	ret0, _ := ret[0].(model.SegmentInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSegmentRepository) GetAll(ctx context.Context) ([]model.SegmentInfo, error) {
	m.ctrl.T.Helper()
