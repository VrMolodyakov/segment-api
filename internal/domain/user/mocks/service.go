...
func (m *MockUserRepository) Create(ctx context.Context, user user.User) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Get(ctx context.Context, userID int64) (user.User, error) {
	m.ctrl.T.Helper()
